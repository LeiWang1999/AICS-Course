# -*- coding: utf-8 -*-
#
# tf-lenet documentation build configuration file, created by
...
project = u'tf-lenet'
copyright = u'2017, Ragav Venkatesan'
...
#
html_title = u'Lenet in TensorFlow'

# A shorter title for the navigation bar.  Default is the same as html_title.
#
html_short_title = 'tf-lenet'
...
latex_documents = [
    (master_doc, 'tf-lenet.tex', u'tf-lenet Documentation',
...
man_pages = [
    (master_doc, 'tf-lenet', u'tf-lenet Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tf-lenet', u'tf-lenet Documentation',
     author, 'tf-lenet', 'One line description of project.',
     'Miscellaneous'),
]
...
def linkcode_resolve(domain, info):
    ...
    return "https://github.com/ragavvenkatesan/tf-lenet/blob/master/%s" % (conca) 
